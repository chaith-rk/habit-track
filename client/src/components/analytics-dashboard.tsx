  ...
  return (
    <section className="mb-8">
      <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-6">
        <h3 className="text-lg font-semibold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent mb-6">Analytics Dashboard</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="bg-white/40 backdrop-blur-sm rounded-xl border border-white/30 overflow-hidden">
